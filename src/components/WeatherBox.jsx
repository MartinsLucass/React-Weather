...
const WeatherBox = ({ weather }) => {
  ...
  return (
    <div className="flex justify-center items-center">
      <div className="flex flex-col justify-center items-start border-2 dark:border-zinc-700 dark:bg-zinc-800 dark:text-gray-50 bg-zinc-300 text-gray-800 border-zinc-500 rounded-lg w-full sm:w-min-72 p-4">
